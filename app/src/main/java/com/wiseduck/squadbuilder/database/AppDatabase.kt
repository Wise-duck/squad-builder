package com.wiseduck.squadbuilder.database

import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import android.content.Context
import com.wiseduck.squadbuilder.dao.FormationDao
...
@Database(entities = [Formation::class, Player::class], version = 3, exportSchema = false)
